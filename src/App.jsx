  ...
  return (
    <>
      <div className=' d-flex justify-content-center align-items-center mt-5'>
        ...
        <div className='cal rounded '>

          <div >
            <input value={result} className='m-4 mt-5  int' type="text" readOnly placeholder='0' />
          </div>
          <div className=' d-flex justify-content-center align-items-center '>
            <button onClick={handleCLear} className='btn btn-outline-secondary  btnl'>AC</button>
            <button onClick={handleDel} className='btn btn-outline-secondary btnl'>Del</button>
          ...
          <div className=' d-flex justify-content-center align-items-center  '>
            ...
            <button onClick={() => displayinp('*')} value={'*'} className='btn btn-outline-secondary btnm'>x</button>
          ...
          <div className=' d-flex justify-content-center align-items-center '>
            ...
            <button onClick={() => displayinp('.')} value={'.'} className='btn btn-outline-secondary btnm'>.</button>
            <button onClick={handleResult} value={'*'} className='btn btn-outline-secondary btnm'>=</button>
